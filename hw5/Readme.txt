...
ast.py		Defines table and class definitions for Decaf's AST. Includes code to perform type-checking on the AST after construction.
Includes code generation to produce Abstract Machine Instructions as an intermediate form of the source code.